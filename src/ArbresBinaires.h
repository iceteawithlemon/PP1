...
extern void *getValeur(sommet s);
...
extern sommet creerArbreBinaire(void *racine);
extern void ajouterFilsGauche(sommet S, void *x);
extern void ajouterFilsDroit(sommet S, void *x);
extern void supprimerFilsGauche(sommet S);
extern void supprimerFilsDroit(sommet S);
extern void detruireArbreBinaire(sommet s);

extern sommet remplirTableauArbre(void *tab[], int len);
